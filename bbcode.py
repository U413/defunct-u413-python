...
html=[
	...
	r'<a href="//\3">\6</a>',
	r'<img src="//\3"/>',
	r'<audio controls="controls" src="//\3">Your browser does not suuport HTML5.(We recommend Google Chrome) You can <a href="//\3">download</a> the audio instead</audio>',
	r'<audio controls="controls" src="//\3">Your browser does not suuport HTML5.(We recommend Google Chrome) You can <a href="//\3">download</a> the audio instead</audio>',
	embed_video,
	r'<div class="quote">\1</div>',
	lambda(match):'<span style="color:%s;">%s</span>'%(colorify(match.group(0)),match.group(1)),
	r'<center>\1</center>',
	lambda(match):'<span style="%s">%s</span>'%(cssify(match.group(0)),match.group(1)),
	r'<br/>',
	r'<hr/>',
